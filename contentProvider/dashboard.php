...
<div class="container">
						...
						<div class="col-xs-8 col-xs-offset-2">
							<div class="input-group">
								...
								<span class="input-group-btn">
									<button class="btn coloredBtn" type="button" style="border-radius:0px; padding:10px;"id="contentProvider-search-btn"><span class="glyphicon glyphicon-search"></span></button>
								</span>
							</div>
				...
				<div class="well" style="max-width: 90%; margin:2% 6%;">
					<table class="table">
					  ...
					  <tbody id="content-dashboard-tab">
						<!--populated by contentProviderData.js-->
					  </tbody>
					</table>
				</div>
			</div>
	...
	<script>
		...
		$(document).ready(function(){
			...
			document.getElementById("username").innerHTML = output["name"]+ "!";
	...
	<script src="../js/contentProviderData.js"></script>
</body>
</html>